...
class Therapist extends Authenticatable implements FilamentUser
{
    ...
    {
        return $this->hasOne(TherapistSubscription::class)->latest();
    }

    public function subscriptions()
    {
        return $this->hasMany(TherapistSubscription::class);
    }
    ...
    {
        return $this->can_accept_bookings && $this->hasActiveSubscription();
    }

    public function getSubscriptionStatusDisplayAttribute()
    {
        $subscription = $this->subscription;
        if (!$subscription)
